...
//    int tick=0;
    ...
    //TODO: IMPORTANT
    // LA FIECARE 30 SEC SE EXECUTA ASTA YEEEE
...
//        }
        ...
        DefaultedRegistry<EntityType<?>> type = Registry.ENTITY_TYPE;
...
//            Components.CURRENT_IDENTITY.get(player).setIdentity(EnderDragonEntity);
        }
